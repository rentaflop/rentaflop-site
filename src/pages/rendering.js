...
export default function Rendering({ user }) {
  ...
  const body = (
    <>
      <Typography component="h1" variant="h6" align="left" fontWeight="600" paddingTop="24px" gutterBottom>What is rentaflop rendering?</Typography>      
	...
	We're so confident you'll enjoy using rentaflop that we'll give you your money back if you're not satisfied with the results.
      ...
      <Typography component="h1" variant="h6" align="left" fontWeight="600" gutterBottom>Is it secure?</Typography>
      <Typography align="left" paragraph>
	...
	our <RentaflopLink href="/pricing" color="info.main">pro tier</RentaflopLink> limits rendering to only machines owned by rentaflop and trusted partners.
      ...
      <Typography component="h1" variant="h6" align="left" fontWeight="600" gutterBottom>How much will it cost to render my project?</Typography>
      <Typography align="left" paragraph>
	...
	See <RentaflopLink href="/pricing" color="info.main">our pricing</RentaflopLink> for more info.
      </Typography>

      <Typography component="h1" variant="h6" align="left" fontWeight="600" gutterBottom>How do I render my project?</Typography>
      <Typography align="left" paragraph>
	...
	according to <RentaflopLink href="/pricing" color="info.main">our pricing</RentaflopLink>.
	...
	the <RentaflopLink href={portal_url+"/ground-control"} color="info.main">ground control</RentaflopLink> page.
      ...
      <Typography component="h1" variant="h6" align="left" fontWeight="600" gutterBottom>How do I prepare my file for rendering?</Typography>
      <Typography align="left" paragraph>
	...
	the result meets your expectations.
      ...
      <Typography component="h1" variant="h6" align="left" fontWeight="600" gutterBottom>What rendering settings do you support?</Typography>
	<Typography align="left" paragraph>
	...
	questions (or need different versions, larger file size, etc.) about rendering, please <RentaflopLink href={portal_url+"/contact"} color="info.main">contact us</RentaflopLink>.
      ...
      <Typography component="h1" variant="h6" align="left" fontWeight="600" gutterBottom>Can I render NSFW projects?</Typography>
      <Typography align="left" paragraph>
