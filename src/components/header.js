    ...
    return (
      <AppBar style={{ backgroundColor: primaryColor, borderBottom: '1px solid', borderColor: lightPrimaryColor }} position='static'>
        <Toolbar>
	      ...
	      <Image src="/static/rentaflop_logo.svg" height={20.18} width={63.63} alt="Rentaflop logo" priority />
	  ...
	  { is_large_screen &&
		...
		<Button href="/about" className={classes.secondary_button_style} variant="text" linkcomponent={Link}>
	      ...
	      <Box marginRight='10px'>
		<Button href="/blog" className={classes.secondary_button_style} variant="text" linkcomponent={Link}>
		  {button_text["blog"]}
		</Button>
	      </Box>
	    </>
